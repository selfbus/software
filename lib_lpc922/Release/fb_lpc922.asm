...
; This file was generated Sat Apr 27 17:56:07 2013
;--------------------------------------------------------
	.module fb_lpc922
...
;	..\fb_lpc922.c:399: if (eeprom[ADDRTAB]) {
	...
	movc	a,@a+dptr
	jz	00107$
	C$fb_lpc922.c$400$1$1 ==.
;	..\fb_lpc922.c:400: for (n=1;n < eeprom[ADDRTAB];n++) {
	mov	r5,#0x01
00109$:
	mov	dptr,#(_eeprom + 0x0016)
	clr	a
...
;	..\fb_lpc922.c:429: ga=find_ga(objno);					// wenn keine Gruppenadresse hinterlegt nix tun
	mov	dpl,r7
	push	ar7
	push	bits
	lcall	_find_ga
...
;	..\fb_lpc922.c:432: telegramm[0]=0xBC;
	mov	_telegramm,#0xBC
	C$fb_lpc922.c$433$3$3 ==.
;	..\fb_lpc922.c:433: telegramm[1]=eeprom[ADDRTAB+1];
	mov	dptr,#(_eeprom + 0x0017)
	clr	a
	movc	a,@a+dptr
	mov	r4,a
...
;	..\fb_lpc922.c:434: telegramm[2]=eeprom[ADDRTAB+2];
	mov	dptr,#(_eeprom + 0x0018)
	clr	a
	movc	a,@a+dptr
	mov	r4,a
...
;	..\fb_lpc922.c:435: telegramm[3]=ga>>8;
	mov	ar4,r6
	mov	(_telegramm + 0x0003),r4
	C$fb_lpc922.c$436$3$3 ==.
;	..\fb_lpc922.c:436: telegramm[4]=ga;
	mov	(_telegramm + 0x0004),r5
	C$fb_lpc922.c$437$3$3 ==.
;	..\fb_lpc922.c:437: telegramm[6]=0x00;
	mov	(_telegramm + 0x0006),#0x00
	C$fb_lpc922.c$438$3$3 ==.
;	..\fb_lpc922.c:438: if (type) telegramm[7]=0x40;		// read_value_response Telegramm (angefordert)
	jnb	b2,00102$
	mov	(_telegramm + 0x0007),#0x40
	sjmp	00103$
00102$:
	C$fb_lpc922.c$439$3$3 ==.
;	..\fb_lpc922.c:439: else telegramm[7]=0x80;				// write_value_request Telegramm (nicht angefordert)
	mov	(_telegramm + 0x0007),#0x80
00103$:
	C$fb_lpc922.c$441$3$3 ==.
;	..\fb_lpc922.c:441: objtype=eeprom[eeprom[COMMSTABPTR]+objno*3+4];
...
;	..\fb_lpc922.c:443: if(objtype>6) length=objtype-5; else length=1;
	mov  r6,a
	add	a,#0xff - 0x06
	jnc	00105$
	mov	a,r6
...
;	..\fb_lpc922.c:444: telegramm[5]=0xE0+length;
	mov	a,#0xE0
	add	a,r6
	mov	(_telegramm + 0x0005),a
	C$fb_lpc922.c$445$3$3 ==.
;	..\fb_lpc922.c:445: if (length>1) telegramm[length+6]=objvalue; else telegramm[7]+=(objvalue&0x3F);
	mov	a,r6
	add	a,#0xff - 0x01
	jnc	00108$
	mov	a,#0x06
...
;	..\fb_lpc922.c:446: if (length>2) telegramm[length+5]=objvalue>>8;
	mov	a,r6
	add	a,#0xff - 0x02
	jnc	00111$
	mov	a,#0x05
...
;	..\fb_lpc922.c:447: if (length>3) telegramm[length+4]=objvalue>>16;
	mov	a,r6
	add	a,#0xff - 0x03
	jnc	00113$
	mov	a,#0x04
...
;	..\fb_lpc922.c:448: if (length>4) telegramm[length+3]=objvalue>>24;
	mov	a,r6
	add	a,#0xff - 0x04
	jnc	00115$
	mov	a,#0x03
...
;	..\fb_lpc922.c:450: build_ok=1;
	setb	b0
	ljmp	00131$
00130$:
	C$fb_lpc922.c$454$2$4 ==.
;	..\fb_lpc922.c:454: telegramm[0]=0xB0;				// Control Byte
	mov	_telegramm,#0xB0
	C$fb_lpc922.c$455$2$4 ==.
;	..\fb_lpc922.c:455: telegramm[1]=eeprom[ADDRTAB+1];	// Quelladresse ist phys. Adresse
	mov	dptr,#(_eeprom + 0x0017)
	clr	a
	movc	a,@a+dptr
	mov	r6,a
...
;	..\fb_lpc922.c:456: telegramm[2]=eeprom[ADDRTAB+2];
	mov	dptr,#(_eeprom + 0x0018)
	clr	a
	movc	a,@a+dptr
	mov	r6,a
...
;	..\fb_lpc922.c:457: telegramm[3]=conh;
	mov	(_telegramm + 0x0003),_conh
	C$fb_lpc922.c$458$2$4 ==.
;	..\fb_lpc922.c:458: telegramm[4]=conl;
	mov	(_telegramm + 0x0004),_conl
	C$fb_lpc922.c$460$2$4 ==.
;	..\fb_lpc922.c:460: switch(objno&0x1F) {
	anl	ar7,#0x1F
	mov	a,r7
	add	a,#0xff - 0x05
	jnc	00164$
...
;	..\fb_lpc922.c:461: case 1:	// NCD ACK Quittierung (129)
00118$:
	C$fb_lpc922.c$462$3$5 ==.
;	..\fb_lpc922.c:462: telegramm[5]=0x60;					// DRL
	mov	(_telegramm + 0x0005),#0x60
	C$fb_lpc922.c$463$3$5 ==.
;	..\fb_lpc922.c:463: telegramm[6]=senders_pcount + 0xC2;	// Bit 6,7(TCPI = 11 NCD Quittierung) und Bit 0,1 (10=ACK)
	mov	a,#0xC2
	add	a,_senders_pcount
	mov	(_telegramm + 0x0006),a
	C$fb_lpc922.c$465$3$5 ==.
;	..\fb_lpc922.c:465: break;
	ljmp	00128$
	C$fb_lpc922.c$466$3$5 ==.
;	..\fb_lpc922.c:466: case 2:	// read mask response (130)
00119$:
	C$fb_lpc922.c$467$3$5 ==.
;	..\fb_lpc922.c:467: telegramm[5]=0x63;					// DRL
	mov	(_telegramm + 0x0005),#0x63
	C$fb_lpc922.c$468$3$5 ==.
;	..\fb_lpc922.c:468: telegramm[6]=pcount + 0x43;			// bei response immer eigene Paketnummer senden
	mov	a,#0x43
	add	a,_pcount
	mov	(_telegramm + 0x0006),a
	C$fb_lpc922.c$469$3$5 ==.
;	..\fb_lpc922.c:469: telegramm[7]=0x40;
	mov	(_telegramm + 0x0007),#0x40
	C$fb_lpc922.c$470$3$5 ==.
;	..\fb_lpc922.c:470: telegramm[8]=0x00;
	mov	(_telegramm + 0x0008),#0x00
	C$fb_lpc922.c$471$3$5 ==.
;	..\fb_lpc922.c:471: telegramm[9]=0x12;					// Maskenversion 1 = BCU1
	mov	(_telegramm + 0x0009),#0x12
	C$fb_lpc922.c$472$3$5 ==.
;	..\fb_lpc922.c:472: inc_pcount=1;
	setb	_inc_pcount
	C$fb_lpc922.c$473$3$5 ==.
;	..\fb_lpc922.c:473: break;
	ljmp	00128$
	C$fb_lpc922.c$474$3$5 ==.
;	..\fb_lpc922.c:474: case 3:	// read PA response (131)
00120$:
	C$fb_lpc922.c$475$3$5 ==.
;	..\fb_lpc922.c:475: telegramm[3]=0x00;			// Zieladresse auf 0000, da Broadcast
	mov	(_telegramm + 0x0003),#0x00
	C$fb_lpc922.c$476$3$5 ==.
;	..\fb_lpc922.c:476: telegramm[4]=0x00;
	mov	(_telegramm + 0x0004),#0x00
	C$fb_lpc922.c$477$3$5 ==.
;	..\fb_lpc922.c:477: telegramm[5]=0xE1;			// DRL
	mov	(_telegramm + 0x0005),#0xE1
	C$fb_lpc922.c$478$3$5 ==.
;	..\fb_lpc922.c:478: telegramm[6]=0x01;
	mov	(_telegramm + 0x0006),#0x01
	C$fb_lpc922.c$479$3$5 ==.
;	..\fb_lpc922.c:479: telegramm[7]=0x40;
	mov	(_telegramm + 0x0007),#0x40
	C$fb_lpc922.c$480$3$5 ==.
;	..\fb_lpc922.c:480: break;
	C$fb_lpc922.c$481$3$5 ==.
;	..\fb_lpc922.c:481: case 4:	// memory_read_response (132)
	sjmp	00128$
00121$:
	C$fb_lpc922.c$482$1$1 ==.
;	..\fb_lpc922.c:482: for(n=0;n<mem_length;n++) {
	mov	r7,#0x00
00134$:
	clr	c
	mov	a,r7
...
;	..\fb_lpc922.c:483: if (mem_adrh==0) {
	mov	a,_mem_adrh
	jnz	00125$
	C$fb_lpc922.c$484$5$7 ==.
;	..\fb_lpc922.c:484: telegramm[n+10]=userram[mem_adrl+n];
	mov	a,#0x0A
	add	a,r7
	add	a,#_telegramm
	mov	r1,a
	...
	movc	a,@a+dptr
	mov	@r1,a
	C$fb_lpc922.c$485$5$7 ==.
;	..\fb_lpc922.c:485: if(mem_adrl+n==0x60) telegramm[n+10]=status60;	// ausser bei 0x60
	mov	r5,_mem_adrl
	mov	r6,#0x00
	mov	ar3,r7
	mov	r4,#0x00
	...
	sjmp	00136$
00125$:
	C$fb_lpc922.c$487$4$6 ==.
;	..\fb_lpc922.c:487: else telegramm[n+10]=eeprom[mem_adrl+n];
	mov	a,#0x0A
	add	a,r7
	add	a,#_telegramm
	mov	r1,a
...
;	..\fb_lpc922.c:489: telegramm[5]=mem_length+0x63;		// DRL (Anzahl Bytes + 3)
	mov	a,#0x63
	add	a,_mem_length
	mov	(_telegramm + 0x0005),a
	C$fb_lpc922.c$490$3$5 ==.
;	..\fb_lpc922.c:490: telegramm[6]=pcount|0x42;			// eigener Paketzaehler, TCPI und ersten beiden Befehlsbits
	mov	a,#0x42
	orl	a,_pcount
	mov	(_telegramm + 0x0006),a
	C$fb_lpc922.c$491$3$5 ==.
;	..\fb_lpc922.c:491: telegramm[7]=mem_length|0x40;		// letzten 2 Befehlsbits
	mov	a,#0x40
	orl	a,_mem_length
	mov	(_telegramm + 0x0007),a
	C$fb_lpc922.c$492$3$5 ==.
;	..\fb_lpc922.c:492: telegramm[8]=mem_adrh;
	mov	(_telegramm + 0x0008),_mem_adrh
	C$fb_lpc922.c$493$3$5 ==.
;	..\fb_lpc922.c:493: telegramm[9]=mem_adrl;
	mov	(_telegramm + 0x0009),_mem_adrl
	C$fb_lpc922.c$494$3$5 ==.
;	..\fb_lpc922.c:494: inc_pcount=1;
	setb	_inc_pcount
	C$fb_lpc922.c$495$3$5 ==.
;	..\fb_lpc922.c:495: break;
	C$fb_lpc922.c$496$3$5 ==.
;	..\fb_lpc922.c:496: case 5:	// T-disconnect (133)
	sjmp	00128$
00127$:
	C$fb_lpc922.c$497$3$5 ==.
;	..\fb_lpc922.c:497: telegramm[5]=0x60;
	mov	(_telegramm + 0x0005),#0x60
	C$fb_lpc922.c$498$3$5 ==.
;	..\fb_lpc922.c:498: telegramm[6]=0x81;
	mov	(_telegramm + 0x0006),#0x81
	C$fb_lpc922.c$500$2$4 ==.
;	..\fb_lpc922.c:500: }
00128$:
	C$fb_lpc922.c$501$2$4 ==.
;	..\fb_lpc922.c:501: build_ok=1;
	setb	b0
00131$:
	C$fb_lpc922.c$503$1$1 ==.
;	..\fb_lpc922.c:503: if(repeatflag) telegramm[0]&=0xDF;		// Wiederholungsbit löschen für Wiederholtelegramm
	jnb	b1,00133$
	mov	a,#0xDF
	anl	a,_telegramm
	mov	_telegramm,a
...
;	..\fb_lpc922.c:504: return(build_ok);
	mov	c,b0
	mov	sp,_bp
	pop	_bp
...
;	..\fb_lpc922.c:508: __bit send_obj_value(unsigned char objno)
;	-----------------------------------------
...
;	..\fb_lpc922.c:510: __bit success=0;
	clr	b0
	C$fb_lpc922.c$512$1$1 ==.
;	..\fb_lpc922.c:512: if(tx_nextsend!=((tx_nextwrite+1)&0x07)) {
...
;	..\fb_lpc922.c:513: tx_buffer[tx_nextwrite]=objno;
	...
	mov	r0,a
	mov	@r0,ar7
	C$fb_lpc922.c$514$2$2 ==.
;	..\fb_lpc922.c:514: tx_nextwrite++;
	inc	_tx_nextwrite
	C$fb_lpc922.c$515$2$2 ==.
...
;	..\fb_lpc922.c:518: TR1=1;	// statemachine starten falls vorher in state 0 gestoppt
	setb	_TCON_6
	C$fb_lpc922.c$519$1$1 ==.
;	..\fb_lpc922.c:519: return(success);
	mov	c,b0
...
;	..\fb_lpc922.c:525: void process_tel(void)
;	-----------------------------------------
;	 function process_tel
;	-----------------------------------------
_process_tel:
	C$fb_lpc922.c$529$1$1 ==.
;	..\fb_lpc922.c:529: tel_arrived=0;
	clr	_tel_arrived
	C$fb_lpc922.c$530$1$1 ==.
;	..\fb_lpc922.c:530: tpdu=telegramm[6]&0xC3;
	mov	r7,(_telegramm + 0x0006)
	mov	a,#0xC3
	anl	a,r7
	mov	r6,a
	C$fb_lpc922.c$531$1$1 ==.
;	..\fb_lpc922.c:531: apdu=telegramm[7];
	mov	r5,(_telegramm + 0x0007)
	C$fb_lpc922.c$534$1$1 ==.
;	..\fb_lpc922.c:534: if(telegramm[3]==0 && telegramm[4]==0) {	// nur wenn wenn Zieladresse = 0
	mov	a,(_telegramm + 0x0003)
	mov	r4,a
	jnz	00144$
	mov	a,(_telegramm + 0x0004)
	jnz	00144$
	C$fb_lpc922.c$535$2$2 ==.
;	..\fb_lpc922.c:535: if(status60 & 0x01) {					// und nur im prog mode
	mov	a,_status60
	jb	acc.0,00178$
	ljmp	00147$
00178$:
	C$fb_lpc922.c$536$3$3 ==.
;	..\fb_lpc922.c:536: if(tpdu==BROADCAST_PDU_SET_PA_REQ && apdu==SET_PHYSADDR_REQUEST) set_pa();				// 00000000 11000000
	mov	a,r6
	jnz	00102$
	cjne	r5,#0xC0,00102$
	push	ar6
...
;	..\fb_lpc922.c:537: if(tpdu==BROADCAST_PDU_READ_PA && apdu==READ_PHYSADDR_REQUEST) send_obj_value(READ_PHYSADDR_RESPONSE);	// 00000001 00000000
	cjne	r6,#0x01,00182$
	sjmp	00183$
00182$:
	ljmp	00147$
...
00184$:
	...
	ljmp	00147$
00144$:
	C$fb_lpc922.c$542$2$4 ==.
;	..\fb_lpc922.c:542: if((telegramm[5]&0x80)==0x00) {	// Destination Adress Flag Bit 7, 0=phys. Adr., 1=Gruppenadr.
	mov	a,(_telegramm + 0x0005)
	jnb	acc.7,00185$
	ljmp	00141$
00185$:
	C$fb_lpc922.c$543$3$5 ==.
;	..\fb_lpc922.c:543: if(telegramm[3]==eeprom[ADDRTAB+1] && telegramm[4]==eeprom[ADDRTAB+2]) {	// nur wenn es die eigene phys. Adr. ist
	mov	dptr,#(_eeprom + 0x0017)
	clr	a
	movc	a,@a+dptr
	mov	r3,a
...
00188$:
	ljmp	00147$
00189$:
	C$fb_lpc922.c$547$4$6 ==.
;	..\fb_lpc922.c:547: switch (tpdu) {	// transport layer control field
	cjne	r6,#0x42,00190$
	sjmp	00109$
00190$:
	cjne	r6,#0x43,00191$
...
00194$:
	ljmp	00147$
	C$fb_lpc922.c$549$5$7 ==.
;	..\fb_lpc922.c:549: case DATA_PDU_MEMORY_OPERATIONS:
00109$:
	C$fb_lpc922.c$550$5$7 ==.
;	..\fb_lpc922.c:550: if(connected){ 
	jb	_connected,00195$
	ljmp	00147$
00195$:
	C$fb_lpc922.c$551$6$8 ==.
;	..\fb_lpc922.c:551: senders_pcount=telegramm[6]&0x3C;
	mov	a,#0x3C
	anl	a,r7
	mov	_senders_pcount,a
	C$fb_lpc922.c$552$6$8 ==.
;	..\fb_lpc922.c:552: apdu &= 0xF0;						// da bei memory operations nur obere 4 Bits aktiv
	anl	ar5,#0xF0
	C$fb_lpc922.c$553$6$8 ==.
;	..\fb_lpc922.c:553: if(apdu==WRITE_MEMORY_REQUEST) {	// 01pppp10 1000xxxx
	cjne	r5,#0x80,00111$
	C$fb_lpc922.c$554$7$9 ==.
;	..\fb_lpc922.c:554: send_obj_value(NCD_ACK);
	mov	dpl,#0x81
	push	ar5
	lcall	_send_obj_value
	C$fb_lpc922.c$555$7$9 ==.
;	..\fb_lpc922.c:555: write_memory();
	lcall	_write_memory
	pop	ar5
00111$:
	C$fb_lpc922.c$557$6$8 ==.
;	..\fb_lpc922.c:557: if(apdu==READ_MEMORY_REQUEST) {		// 01pppp10 0000xxxx
	mov	a,r5
	jnz	00147$
	C$fb_lpc922.c$558$7$10 ==.
;	..\fb_lpc922.c:558: mem_length=telegramm[7];		// Anzahl Bytes für späteres(!) memory Auslesen
	mov	_mem_length,(_telegramm + 0x0007)
	C$fb_lpc922.c$559$7$10 ==.
;	..\fb_lpc922.c:559: mem_adrh = telegramm[8];		// Adresse
	mov	_mem_adrh,(_telegramm + 0x0008)
	C$fb_lpc922.c$560$7$10 ==.
;	..\fb_lpc922.c:560: mem_adrl = telegramm[9];
	mov	_mem_adrl,(_telegramm + 0x0009)
	C$fb_lpc922.c$561$7$10 ==.
;	..\fb_lpc922.c:561: send_obj_value(NCD_ACK);
	mov	dpl,#0x81
	lcall	_send_obj_value
	C$fb_lpc922.c$562$7$10 ==.
;	..\fb_lpc922.c:562: send_obj_value(READ_MEMORY_RESPONSE);
	mov	dpl,#0x84
	lcall	_send_obj_value
	C$fb_lpc922.c$565$5$7 ==.
;	..\fb_lpc922.c:565: break;
	C$fb_lpc922.c$567$5$7 ==.
;	..\fb_lpc922.c:567: case DATA_PDU_MISC_OPERATIONS:
	sjmp	00147$
00116$:
	C$fb_lpc922.c$568$5$7 ==.
;	..\fb_lpc922.c:568: senders_pcount=telegramm[6]&0x3C;
	mov	a,#0x3C
	anl	a,r7
	mov	_senders_pcount,a
	C$fb_lpc922.c$569$5$7 ==.
;	..\fb_lpc922.c:569: if(apdu==RESTART_REQUEST) {		// 01pppp11 10000000
	cjne	r5,#0x80,00118$
	C$fb_lpc922.c$570$6$11 ==.
;	..\fb_lpc922.c:570: AUXR1|=0x08;				// Software Reset
	orl	_AUXR1,#0x08
00118$:
	C$fb_lpc922.c$572$5$7 ==.
;	..\fb_lpc922.c:572: if(apdu==READ_MASK_VERSION_REQUEST) {		// 01pppp11 00000000
	mov	a,r5
	jnz	00147$
	C$fb_lpc922.c$573$6$12 ==.
;	..\fb_lpc922.c:573: send_obj_value(NCD_ACK);
	mov	dpl,#0x81
	lcall	_send_obj_value
	C$fb_lpc922.c$574$6$12 ==.
;	..\fb_lpc922.c:574: send_obj_value(READ_MASK_VERSION_RESPONSE);
	mov	dpl,#0x82
	lcall	_send_obj_value
	C$fb_lpc922.c$576$5$7 ==.
;	..\fb_lpc922.c:576: break;
	C$fb_lpc922.c$578$5$7 ==.
;	..\fb_lpc922.c:578: case CONNECT_PDU:	// 10000000 xxxxxxxx
	sjmp	00147$
00121$:
	C$fb_lpc922.c$579$5$7 ==.
;	..\fb_lpc922.c:579: if(!connected) {				// wenn bereits verbunden: ignorieren
	jb	_connected,00147$
	C$fb_lpc922.c$580$6$13 ==.
;	..\fb_lpc922.c:580: connected=1;
	setb	_connected
	C$fb_lpc922.c$581$6$13 ==.
;	..\fb_lpc922.c:581: conh=telegramm[1];			// phys. Adresse des Verbindungspartners
	mov	_conh,(_telegramm + 0x0001)
	C$fb_lpc922.c$582$6$13 ==.
;	..\fb_lpc922.c:582: conl=telegramm[2];
	mov	_conl,(_telegramm + 0x0002)
	C$fb_lpc922.c$583$6$13 ==.
;	..\fb_lpc922.c:583: pcount=0;					// Paketzaehler zuruecksetzen
	mov	_pcount,#0x00
	C$fb_lpc922.c$584$6$13 ==.
;	..\fb_lpc922.c:584: inc_pcount=0;
	clr	_inc_pcount
	C$fb_lpc922.c$586$5$7 ==.
;	..\fb_lpc922.c:586: break;
	C$fb_lpc922.c$588$5$7 ==.
;	..\fb_lpc922.c:588: case DISCONNECT_PDU:	// 10000001 xxxxxxxx
	sjmp	00147$
00124$:
	C$fb_lpc922.c$589$5$7 ==.
;	..\fb_lpc922.c:589: if(conh==telegramm[1] && conl==telegramm[2] && connected)	{	// nur abbauen, wenn verbunden und Anforderung vom Verbindungspartner, kein ACK senden
	mov	a,(_telegramm + 0x0001)
	cjne	a,_conh,00147$
	mov	a,(_telegramm + 0x0002)
	cjne	a,_conl,00147$
	C$fb_lpc922.c$590$6$14 ==.
;	..\fb_lpc922.c:590: connected=0;
	jbc	_connected,00207$
	sjmp	00147$
00207$:
	C$fb_lpc922.c$594$5$7 ==.
;	..\fb_lpc922.c:594: break;
	C$fb_lpc922.c$596$5$7 ==.
;	..\fb_lpc922.c:596: case NACK_PDU:	// 11pppp11 xxxxxxxx
	sjmp	00147$
00129$:
	C$fb_lpc922.c$597$5$7 ==.
;	..\fb_lpc922.c:597: send_obj_value(T_DISCONNECT);
	mov	dpl,#0x85
	lcall	_send_obj_value
	C$fb_lpc922.c$599$2$4 ==.
;	..\fb_lpc922.c:599: }
	sjmp	00147$
00141$:
	C$fb_lpc922.c$605$3$15 ==.
;	..\fb_lpc922.c:605: if(tpdu==GROUP_PDU){
	mov	a,r6
	jnz	00147$
	C$fb_lpc922.c$606$4$16 ==.
;	..\fb_lpc922.c:606: if((apdu&0xC0)==WRITE_GROUP) write_value_req();	// Objektwerte schreiben (zB. EISx)		00000000 10xxxxxx
	mov	a,#0xC0
	anl	a,r5
	mov	r7,a
	cjne	r7,#0x80,00135$
	...
	pop	ar5
00135$:
	C$fb_lpc922.c$607$4$16 ==.
;	..\fb_lpc922.c:607: if(apdu==READ_GROUP_REQUEST) read_value_req();	// Objektwert lesen und read_value_response senden	00000000 00000000
	mov	a,r5
	jnz	00147$
	lcall	_read_value_req
00147$:
	C$fb_lpc922.c$611$1$1 ==.
	XG$process_tel$0$0 ==.
	ret
;------------------------------------------------------------
...
;	..\fb_lpc922.c:618: void write_memory(void)
;	-----------------------------------------
...
;	..\fb_lpc922.c:622: ab=telegramm[7]&0x0F;		// Anzahl Bytes
	mov	r0,_bp
	inc	r0
	mov	a,#0x0F
	anl	a,(_telegramm + 0x0007)
	mov	@r0,a
	C$fb_lpc922.c$624$1$1 ==.
;	..\fb_lpc922.c:624: while(fb_state!=0);					// warten falls noch gesendet wird
00101$:
	mov	a,_fb_state
	jnz	00101$
	C$fb_lpc922.c$626$1$1 ==.
;	..\fb_lpc922.c:626: EA=0;
	clr	_IEN0_7
	C$fb_lpc922.c$627$1$1 ==.
;	..\fb_lpc922.c:627: START_WRITECYCLE;					// load command, leert das pageregister
	mov	_FMCON,#0x00
	C$fb_lpc922.c$628$2$2 ==.
;	..\fb_lpc922.c:628: for(n=0;n<ab;n++) {
...
00111$:
	...
	ljmp	00114$
00127$:
	C$fb_lpc922.c$629$2$2 ==.
;	..\fb_lpc922.c:629: if(telegramm[8]==0 && (telegramm[9]+n)==0x60) status60=telegramm[10+n];
	mov	a,r5
	jnz	00105$
	push	ar4
	mov	ar2,r6
...
00130$:
	...
	sjmp	00106$
00105$:
	C$fb_lpc922.c$630$2$2 ==.
;	..\fb_lpc922.c:630: else WRITE_BYTE(telegramm[8],telegramm[9]+n,telegramm[n+10]);
	mov	_FMADRH,r4
00106$:
	mov	r0,_bp
	inc	r0
...
;	..\fb_lpc922.c:632: if ((((telegramm[9]+n)&0x3F)==0x3F) && n!=(ab-1)) {		// Ende des 64-Byte Pageregisters, also zwischendurch flashen
	mov	ar3,r6
	mov	r7,#0x00
	mov	r0,_bp
	inc	r0
...
00133$:
	...
	sjmp	00113$
00134$:
	C$fb_lpc922.c$633$3$3 ==.
;	..\fb_lpc922.c:633: STOP_WRITECYCLE;			// write command, schreibt pageregister ins flash und versetzt CPU in idle fuer 4ms
	mov	_FMCON,#0x68
	C$fb_lpc922.c$634$3$3 ==.
;	..\fb_lpc922.c:634: START_WRITECYCLE;		// load command, leert das pageregister
	mov	_FMCON,#0x00
00113$:
	C$fb_lpc922.c$628$1$1 ==.
;	..\fb_lpc922.c:628: for(n=0;n<ab;n++) {
	mov	r0,_bp
	inc	r0
	inc	r0
...
;	..\fb_lpc922.c:637: STOP_WRITECYCLE;					// write command, schreibt pageregister ins flash und versetzt CPU in idle fuer 4ms
	mov	_FMCON,#0x68
	C$fb_lpc922.c$638$1$1 ==.
;	..\fb_lpc922.c:638: EA=1;
	setb	_IEN0_7
	mov	sp,_bp
	pop	_bp
...
;	..\fb_lpc922.c:643: void set_pa(void)
;	-----------------------------------------
;	 function set_pa
;	-----------------------------------------
_set_pa:
	C$fb_lpc922.c$645$1$1 ==.
;	..\fb_lpc922.c:645: while(fb_state!=0);		// warten falls noch gesendet wird
00101$:
	mov	a,_fb_state
	jnz	00101$
	C$fb_lpc922.c$646$1$1 ==.
;	..\fb_lpc922.c:646: EA=0;
	clr	_IEN0_7
	C$fb_lpc922.c$647$1$1 ==.
;	..\fb_lpc922.c:647: FMCON=0x00;				// load command, leert das pageregister
	mov	_FMCON,#0x00
	C$fb_lpc922.c$648$1$1 ==.
;	..\fb_lpc922.c:648: FMADRH=0x1D;
	mov	_FMADRH,#0x1D
	C$fb_lpc922.c$649$1$1 ==.
;	..\fb_lpc922.c:649: FMADRL=ADDRTAB+1;
	mov	_FMADRL,#0x17
	C$fb_lpc922.c$650$1$1 ==.
;	..\fb_lpc922.c:650: FMDATA=telegramm[8];
	mov	_FMDATA,(_telegramm + 0x0008)
	C$fb_lpc922.c$651$1$1 ==.
;	..\fb_lpc922.c:651: FMDATA=telegramm[9];	// nächstes Byte, da autoinkrement
	mov	_FMDATA,(_telegramm + 0x0009)
	C$fb_lpc922.c$652$1$1 ==.
;	..\fb_lpc922.c:652: FMCON=0x68;				// write command, schreibt pageregister ins flash und versetzt CPU in idle fuer 4ms
	mov	_FMCON,#0x68
	C$fb_lpc922.c$653$1$1 ==.
;	..\fb_lpc922.c:653: EA=1;
	setb	_IEN0_7
...
;------------------------------------------------------------
	G$read_objflags$0$0 ==.
	C$fb_lpc922.c$659$1$1 ==.
;	..\fb_lpc922.c:659: unsigned char read_objflags(unsigned char objno)
;	-----------------------------------------
...
;	..\fb_lpc922.c:662: return(eeprom[eeprom[COMMSTABPTR]+3+objno+objno+objno]);
	mov	dptr,#(_eeprom + 0x0012)
	clr	a
	movc	a,@a+dptr
	mov	r6,a
...
;	..\fb_lpc922.c:667: unsigned char find_first_objno(unsigned char gah, unsigned char gal)
;	-----------------------------------------
...
_find_first_objno:
	...
	mov	_bp,sp
	mov	r7,dpl
	C$fb_lpc922.c$671$1$1 ==.
;	..\fb_lpc922.c:671: objno=0xFF;
	mov	r6,#0xFF
	C$fb_lpc922.c$672$1$1 ==.
;	..\fb_lpc922.c:672: gaposgat=gapos_in_gat(gah,gal);
	push	ar6
	mov	a,_bp
	add	a,#0xfd
	mov	r0,a
...
;	..\fb_lpc922.c:674: atp=eeprom[ASSOCTABPTR];	// Pointer auf Assoziationstabelle
	mov	dptr,#(_eeprom + 0x0011)
	clr	a
	movc	a,@a+dptr
	C$fb_lpc922.c$675$1$1 ==.
;	..\fb_lpc922.c:675: assmax=eeprom[atp];			// Anzahl Assoziationen
	mov	r5,a
	mov	dpl,a
	mov	dph,#(_eeprom >> 8)
	clr	a
	movc	a,@a+dptr
	mov	r4,a
	C$fb_lpc922.c$676$1$1 ==.
;	..\fb_lpc922.c:676: if (gaposgat!=0xFF) {	// falls Gruppenadresse nicht vorhanden
	cjne	r7,#0xFF,00115$
	sjmp	00107$
00115$:
	C$fb_lpc922.c$677$2$2 ==.
;	..\fb_lpc922.c:677: n=0;
	mov	r3,#0x00
	C$fb_lpc922.c$678$2$2 ==.
;	..\fb_lpc922.c:678: asspos=atp+1;
	inc	r5
	C$fb_lpc922.c$679$1$1 ==.
;	..\fb_lpc922.c:679: while(n<assmax) { 	// Schleife ueber Assoziationstabelle
00103$:
	clr	c
	mov	a,r3
	subb	a,r4
	jnc	00107$
	C$fb_lpc922.c$680$3$3 ==.
;	..\fb_lpc922.c:680: gaposass=eeprom[asspos];
	mov	dpl,r5
	mov	dph,#(_eeprom >> 8)
	clr	a
	movc	a,@a+dptr
	mov	r2,a
	C$fb_lpc922.c$681$3$3 ==.
;	..\fb_lpc922.c:681: if(gaposgat==gaposass) {
	mov	a,r7
	cjne	a,ar2,00102$
	C$fb_lpc922.c$682$4$4 ==.
;	..\fb_lpc922.c:682: objno=eeprom[asspos+1];
	mov	a,r5
	inc	a
	mov	dptr,#_eeprom
	movc	a,@a+dptr
	mov	r2,a
	mov	r6,a
	C$fb_lpc922.c$683$4$4 ==.
;	..\fb_lpc922.c:683: n=assmax;
	mov	ar3,r4
00102$:
	C$fb_lpc922.c$685$3$3 ==.
;	..\fb_lpc922.c:685: n++;
	inc	r3
	C$fb_lpc922.c$686$3$3 ==.
;	..\fb_lpc922.c:686: asspos+=2;
	inc	r5
	inc	r5
	sjmp	00103$
00107$:
	C$fb_lpc922.c$689$1$1 ==.
;	..\fb_lpc922.c:689: return (objno);
	mov	dpl,r6
	pop	_bp
	C$fb_lpc922.c$690$1$1 ==.
...
;------------------------------------------------------------
	G$find_ga$0$0 ==.
	C$fb_lpc922.c$695$1$1 ==.
;	..\fb_lpc922.c:695: unsigned int find_ga(unsigned char objno)
;	-----------------------------------------
;	 function find_ga
;	-----------------------------------------
_find_ga:
	mov	r7,dpl
	C$fb_lpc922.c$700$1$1 ==.
;	..\fb_lpc922.c:700: gapos=0xFE;
	mov	r6,#0xFE
	C$fb_lpc922.c$701$1$1 ==.
;	..\fb_lpc922.c:701: asstab=eeprom[ASSOCTABPTR];		// Adresse der Assoziationstabelle
	mov	dptr,#(_eeprom + 0x0011)
	clr	a
	movc	a,@a+dptr
	mov	r5,a
	C$fb_lpc922.c$702$1$1 ==.
;	..\fb_lpc922.c:702: asspos=asstab+1+2*objno;
	inc	r5
	mov	a,r7
	add	a,r7
	add	a,r5
	C$fb_lpc922.c$704$1$1 ==.
;	..\fb_lpc922.c:704: if(eeprom[asspos+1]==objno) gapos=eeprom[asspos];
	mov	r5,a
	inc	a
	mov	dptr,#_eeprom
	movc	a,@a+dptr
...
;	..\fb_lpc922.c:706: if(gapos!=0xFE) {
	cjne	r6,#0xFE,00112$
	sjmp	00104$
00112$:
	C$fb_lpc922.c$708$2$2 ==.
;	..\fb_lpc922.c:708: ga=eeprom[ADDRTAB+1+gapos*2]*256;
	mov	a,r6
	add	a,r6
	mov	r6,a
	add	a,#0x17
	...
	mov	r5,a
	mov	r7,#0x00
	C$fb_lpc922.c$709$2$2 ==.
;	..\fb_lpc922.c:709: ga+=eeprom[ADDRTAB+2+gapos*2];
	mov	a,#0x18
	add	a,r6
	mov	dptr,#_eeprom
	movc	a,@a+dptr
...
;	..\fb_lpc922.c:711: else ga=0;
	mov	r7,#0x00
	mov	r5,#0x00
00105$:
	C$fb_lpc922.c$713$1$1 ==.
;	..\fb_lpc922.c:713: return(ga);
	mov	dpl,r7
	mov	dph,r5
...
;	..\fb_lpc922.c:719: void restart_hw(void)
;	-----------------------------------------
;	 function restart_hw
;	-----------------------------------------
_restart_hw:
	C$fb_lpc922.c$721$1$1 ==.
;	..\fb_lpc922.c:721: DIVM=0;			// Taktferquenz nicht teilen -> volles Tempo
	mov	_DIVM,#0x00
	C$fb_lpc922.c$723$1$1 ==.
;	..\fb_lpc922.c:723: P1M1=0x14;		// Port 1 auf quasi-bidirektional,
	mov	_P1M1,#0x14
	C$fb_lpc922.c$724$1$1 ==.
;	..\fb_lpc922.c:724: P1M2=0x4C;		// ausser P1.2(T0 als PWM Ausgang)=open-drain,
	mov	_P1M2,#0x4C
	C$fb_lpc922.c$728$1$1 ==.
;	..\fb_lpc922.c:728: FBOUTC=0;		// Bus-Ausgang auf low
	clr	_P1_6
	C$fb_lpc922.c$730$1$1 ==.
;	..\fb_lpc922.c:730: TMOD=0x21;		// Timer 0 als 16-Bit Timer, Timer 1 als 8 Bit autoreload
	mov	_TMOD,#0x21
	C$fb_lpc922.c$731$1$1 ==.
;	..\fb_lpc922.c:731: TAMOD=0x00;
	mov	_TAMOD,#0x00
	C$fb_lpc922.c$732$1$1 ==.
;	..\fb_lpc922.c:732: TR0=0;			// Timer 0 (zur Verwendung in app) zunaechst stoppen 
	clr	_TCON_4
	C$fb_lpc922.c$733$1$1 ==.
;	..\fb_lpc922.c:733: TR1=0;			// Timer 1 (Empfangs-Timer, nicht in app verwenden!) zunaechst stoppen
	clr	_TCON_6
	C$fb_lpc922.c$734$1$1 ==.
;	..\fb_lpc922.c:734: TH1=128;		// Timer 1 auf 104us/3
	mov	_TH1,#0x80
	C$fb_lpc922.c$735$1$1 ==.
;	..\fb_lpc922.c:735: TL1=128;
	mov	_TL1,#0x80
	C$fb_lpc922.c$736$1$1 ==.
;	..\fb_lpc922.c:736: TF1=0;
	clr	_TCON_7
	C$fb_lpc922.c$743$1$1 ==.
;	..\fb_lpc922.c:743: interrupted=0;	// wird durch die interrupt-routine auf 1 gesetzt
	clr	_interrupted
	C$fb_lpc922.c$744$1$1 ==.
;	..\fb_lpc922.c:744: IEN0=0x80;// mit 0x80 sind die unten auskommentierten erschlagen.
	mov	_IEN0,#0x80
	C$fb_lpc922.c$745$1$1 ==.
;	..\fb_lpc922.c:745: IEN1=0x00;
	mov	_IEN1,#0x00
	C$fb_lpc922.c$752$1$1 ==.
;	..\fb_lpc922.c:752: IP0=0x04;		// höchste Priorität fuer ext1
	mov	_IP0,#0x04
	C$fb_lpc922.c$753$1$1 ==.
;	..\fb_lpc922.c:753: IP0H=0x0C;
	mov	_IP0H,#0x0C
	C$fb_lpc922.c$754$1$1 ==.
;	..\fb_lpc922.c:754: IT1=1;			// Interrupt 1 flankengetriggert=1
	setb	_TCON_2
	C$fb_lpc922.c$756$1$1 ==.
;	..\fb_lpc922.c:756: status60=0x2E;	// Status-Byte (steht normal im userram an 0x60)
	mov	_status60,#0x2E
	C$fb_lpc922.c$758$1$1 ==.
;	..\fb_lpc922.c:758: ack=0;			// ack und nack flag zurücksetzen
	clr	_ack
	C$fb_lpc922.c$759$1$1 ==.
;	..\fb_lpc922.c:759: nack=0;
	clr	_nack
	C$fb_lpc922.c$760$1$1 ==.
;	..\fb_lpc922.c:760: send_ack=0;
	clr	_send_ack
	C$fb_lpc922.c$761$1$1 ==.
;	..\fb_lpc922.c:761: send_nack=0;
	clr	_send_nack
	C$fb_lpc922.c$762$1$1 ==.
;	..\fb_lpc922.c:762: tel_arrived=0;	// kein Telegramm empfangen
	clr	_tel_arrived
	C$fb_lpc922.c$763$1$1 ==.
;	..\fb_lpc922.c:763: auto_ack=1;		// empfangene Telegramme automatisch mit ack bestätigen
	setb	_auto_ack
	C$fb_lpc922.c$764$1$1 ==.
;	..\fb_lpc922.c:764: tx_nextwrite=0;	// Zeiger auf nächste zu schreibende Objektnr. in tx_buffer
	mov	_tx_nextwrite,#0x00
	C$fb_lpc922.c$765$1$1 ==.
;	..\fb_lpc922.c:765: tx_nextsend=0;	// Zeiger auf nächste zu sendende Objektnr. in tx_buffer
	mov	_tx_nextsend,#0x00
	C$fb_lpc922.c$766$1$1 ==.
;	..\fb_lpc922.c:766: pcount=0;		// Paketzaehler initialisieren
	mov	_pcount,#0x00
	C$fb_lpc922.c$767$1$1 ==.
;	..\fb_lpc922.c:767: inc_pcount=0;
	clr	_inc_pcount
	C$fb_lpc922.c$768$1$1 ==.
;	..\fb_lpc922.c:768: connected=0;	// keine Verbindung
	clr	_connected
	C$fb_lpc922.c$769$1$1 ==.
;	..\fb_lpc922.c:769: transparency=0;	// fremde Gruppentelegramme werden ignoriert
	clr	_transparency
	C$fb_lpc922.c$770$1$1 ==.
;	..\fb_lpc922.c:770: init_rx();		// Empfang initialisieren
	lcall	_init_rx
	C$fb_lpc922.c$771$1$1 ==.
	XG$restart_hw$0$0 ==.
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
