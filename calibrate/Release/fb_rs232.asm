...
; This file was generated Sat Aug 06 07:08:46 2011
;--------------------------------------------------------
	.module fb_rs232
...
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:57: TI=1;
	setb	_SCON_1
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:60: IP0 &= 0xEF;
	anl	_IP0,#0xEF
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:61: IP0H &= 0xEF;
	anl	_IP0H,#0xEF
	ret
;------------------------------------------------------------
...
_rs_send_dec:
	mov	r2,dpl
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:144: TI=0;
	clr	_SCON_1
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:145: SBUF=wert+48;
	mov	a,#0x30
	add	a,r2
	mov	_SBUF,a
	ret
...
;------------------------------------------------------------
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:159: void rs_send_s(unsigned char *s)
;	-----------------------------------------
;	 function rs_send_s
;	-----------------------------------------
_rs_send_s:
	...
	mov	r3,dph
	mov	r4,b
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:162: while (s[n]!=0)
	mov	r5,#0x00
00111$:
	mov	a,r5
	add	a,r2
	...
	mov	r6,a
	jz	00113$
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:164: if(s[n]=='\n')
	cjne	r6,#0x0A,00106$
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:166: while(!TI);
00101$:
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:167: TI=0;
	jbc	_SCON_1,00126$
	sjmp	00101$
00126$:
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:168: SBUF=0x0d;
	mov	_SBUF,#0x0D
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:170: while(!TI);
00106$:
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:171: TI=0;
	jbc	_SCON_1,00127$
	sjmp	00106$
00127$:
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:172: SBUF=s[n];
	mov	a,r5
	add	a,r2
	mov	r6,a
	clr	a
	...
	lcall	__gptrget
	mov	_SBUF,a
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:173: n++;
	inc	r5
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:174: if(n>254)
	mov	a,r5
	add	a,#0xff - 0xFE
	jnc	00111$
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:175: return;
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:177: return;
00113$:
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:228: void rs_send_hex_i(unsigned int wert)
;	-----------------------------------------
;	 function rs_send_hex_i
;	-----------------------------------------
_rs_send_hex_i:
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:229: {wert;
	ret
;------------------------------------------------------------
...
;wert                      Allocated to registers 
;------------------------------------------------------------
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:242: void rs_send_hex(unsigned char wert)
;	-----------------------------------------
;	 function rs_send_hex
;	-----------------------------------------
_rs_send_hex:
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:244: wert;
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:253: void rs_send(unsigned char z)
;	-----------------------------------------
;	 function rs_send
;	-----------------------------------------
_rs_send:
	mov	r2,dpl
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:255: while(!TI);
00101$:
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:256: TI=0;
	jbc	_SCON_1,00108$
	sjmp	00101$
00108$:
;	C:/Freebus/C_Programme/oldisprogramm/com/fb_rs232.c:257: SBUF=z;
	mov	_SBUF,r2
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
