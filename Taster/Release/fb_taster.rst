   ...
   00DE C2 8C               663 	clr	_TCON_4
                    0061    664 	C$fb_taster.c$103$2$4 ==.
                            665 ;	../fb_taster.c:103: TH0=eeprom[ADDRTAB+1];	// Timer 0 setzen mit phys. Adr. damit Geräte unterschiedlich beginnen zu senden
   ...
   00EC F5 8A               675 	mov	_TL0,a
                    006F    676 	C$fb_taster.c$105$2$4 ==.
                            677 ;	../fb_taster.c:105: TF0=0;					// Überlauf-Flag zurücksetzen
   ...
   015A 50 33               756 	jnc	00115$
                    00DD    757 	C$fb_taster.c$128$3$8 ==.
                            758 ;	../fb_taster.c:128: RTCCON=0x61;// RTC flag löschen
   ...
   017D                     781 00109$:
                    00FE    782 	C$fb_taster.c$136$4$9 ==.
                            783 ;	../fb_taster.c:136: else send_obj_value(T_DISCONNECT);// wenn timeout dann disconnect, flag und var wird in build_tel() gelöscht
   ...
   01A1 30 E0 3C            813 	jnb	acc.0,00137$
                    0125    814 	C$fb_taster.c$150$3$11 ==.
                            815 ;	../fb_taster.c:150: if ((PORT & 0x0F)==0x0E){	// Taste 1 gedrück
   ...
   01C1                     837 00123$:
                    0142    838 	C$fb_taster.c$156$3$11 ==.
                            839 ;	../fb_taster.c:156: if ((PORT & 0x0F)==0x0D){ // Taste 2 gedrückt
   ...
   0282 D2 97              1028 	setb	_P1_7
                    0205   1029 	C$fb_taster.c$227$2$6 ==.
                           1030 ;	../fb_taster.c:227: if(!TASTER){ // Taster gedrückt
