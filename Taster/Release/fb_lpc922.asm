...
;------------------------------------------------------------
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:60: void X1_int(void) __interrupt (2)		// Flanke des Startbits löst int1 aus
;	-----------------------------------------
;	 function X1_int
;	-----------------------------------------
_X1_int:
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:65: TMOD=(TMOD & 0x0F) + 0x20;	// Timer 1 als 8-Bit autoreload
	...
	add	a,#0x20
	mov	_TMOD,a
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:66: TL1=53;//108;//128;		// Timer laden so dass in state 2 bei 75µs abgefragt wird
	mov	_TL1,#0x35
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:67: TH1=128;//128;			// autoreload auf 35µs setzen (gilt für sprung von 2 auf 3)
	mov	_TH1,#0x80
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:68: TF1=0;			// Timer1-flag löschen						1 cycle
	clr	_TCON_7
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:70: ET1=1;			// Timer1-int aktiv							1 cycle
	setb	_IEN0_3
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:71: fb_state=2;		// nächster state
	mov	_fb_state,#0x02
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:72: fb_parity=0;	// Parity Bit löschen
	clr	_fb_parity
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:73: parity_ok=1;	// wird bei Fehler gelöscht
	setb	_parity_ok
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:95: TH1=128;
	mov	_TH1,#0x80
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:96: TF1=0;			// Timer1-flag löschen						1 cycle
	clr	_TCON_7
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:99: if(build_tel(tx_buffer[tx_nextsend])) {	// wenn Telegramm gebildet werden konnte
	...
	lcall	_build_tel
	jnc	00110$
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:100: EX1=0; 				//Um zu vermeiden dass man in die Abfrage hinein-empfängt
	clr	_IEN0_2
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:102: if((tx_buffer[tx_nextsend]&0x20)==0) {	// wenn erstmaliges Senden des Objektes
	...
	mov	r7,a
	jb	acc.5,00103$
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:103: tx_buffer[tx_nextsend]|=0x20;		// Bit für "wird gerade gesendet"
	mov	a,#0x20
	orl	a,r7
	mov	@r1,a
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:104: repeat_count=0;						// Wiederholungszähler für nicht geackte Telegramme
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:119: EX1=1;	// ext1 int einschalten falls Empfang...
	...
	ljmp	00217$
00110$:
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:122: tx_nextsend++; //hier Zeiger erhöhen wenn Telegramm nicht gebildet werden konnte
	inc	_tx_nextsend
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:134: fbrx_bit=!IE1;				// Flipflop des ext. Int. 1 auslesen, ist 1 bei fallender Flanke am Pin
	...
	cpl	c
	mov	b0,c
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:135: IE1=0;						// Flipflop zurücksetzen
	clr	_TCON_3
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:136: fb_state=3;// nächster state: 3
	mov	_fb_state,#0x03
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:137: TH1=0;// reload auf 70µs (zeit swischen state 3 und 2)
	mov	_TH1,#0x00
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:138: if(fb_pattern==0) {			// fb_pattern=0 bedeutet, dass bisher nur das Startbit empfangen wurde
	mov	a,_fb_pattern
	jnz	00149$
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:139: fb_pattern=1;			// 70us nach Startbit, als näcstes kommt Datenbit 0
	mov	_fb_pattern,#0x01
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:140: ack=0;					// Empfang eines neuen Bytes, also ack/nack Flags zurücksetzen
	clr	_ack
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:147: fbrx_byte+=fb_pattern;			// Datenbit speichern
	...
	mov	_fbrx_byte,a
00117$:
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:149: fb_pattern=fb_pattern<<1;			// nächstes Bit
	mov	a,_fb_pattern
	add	a,_fb_pattern
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:153: TR1=0;
	clr	_TCON_6
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:154: TF1=0; //prüfen ob erforderlich!!!
	clr	_TCON_7
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:162: cs^=fbrx_byte;							// Checksum berechnen
	...
	mov	@r0,a
	xrl	_cs,a
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:163: telpos++;								// Telegrammzeiger erhöhen
	inc	_telpos
	sjmp	00131$
00130$:
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:169: wait_for_ack=0;							// Flag zurücksetzen, da wir es ja gerade abarbeiten
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:183: TH1=0xFA;//0xFA;							// Timer 1 auf Timeout-Position setzen (370us)
	mov	_TH1,#0xFA
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:184: TL1=0x70;//4f 0xAB; (bis hierher sinds 91µs)
	mov	_TL1,#0x70
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:185: TR1=1;
	setb	_TCON_6
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:186: fb_state=4;							// nächster state: timeout = Telegramm fertig
	mov	_fb_state,#0x04
...
00151$:
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:196: TH1=128;// reload auf 35µs (Zeit zwischen State 2 und 3)
	mov	_TH1,#0x80
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:203: TMOD=(TMOD & 0x0F) +0x10;	// Timer 1 als 16-Bit Timer
	...
	add	a,#0x10
	mov	_TMOD,a
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:204: TH1=0xEF;					// Timer 1 auf ACK-Position setzen (15 Bit Pause = 2708µs (26 Bit) nach Beginn Startbit vom letzten Datenbyte)
	mov	_TH1,#0xEF
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:206: TR1=1;
	setb	_TCON_6
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:207: its_me=transparency;			// indiziert, ob dieses Gerät adressiert wurde, bei transparecy=1 immer
	mov	c,_transparency
	mov	_its_me,c
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:213: if ((cs==0xFF) && its_me) tel_arrived=1;
	...
	setb	_tel_arrived
00165$:
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:214: fb_state=5;					// nächster state: ACK-Position erreicht
	mov	_fb_state,#0x05
	ljmp	00217$
00170$:
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:218: if (telpos>1) tel_arrived=1;	// trotzdem den Eingang eines Telegramms anzeigen
	...
	setb	_tel_arrived
00168$:
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:219: init_rx();						// wieder in den Empfang zurück
	lcall	_init_rx
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:225: if (cs==0xFF) {	// Checksum OK
	mov	a,#0xFF
	cjne	a,_cs,00178$
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:226: if (its_me) {					// Gerät adressiert
	jnb	_its_me,00175$
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:229: wait_for_ack=0;					// bei ACK senden nicht erneut auf ACK warten
	...
	ljmp	00217$
00175$:
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:231: else init_rx();					// Gerät nicht adressiert, also zurück zu Empfang
	lcall	_init_rx
	ljmp	00217$
00178$:
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:251: FBOUTC=1;						// Bus runter ziehen
	setb	_P1_6
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:253: fbtx_bit=0;						// fbtx_bit dient zur späteren Kollisionsprüfung
	clr	_fbtx_bit
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:256: else fbtx_bit=1;
	setb	_fbtx_bit
00187$:
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:257: if (fb_pattern==0) {				// wenn Startbit: parity zurücksetzen
	mov	a,_fb_pattern
	jnz	00189$
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:259: fb_parity=0;
	...
	sjmp	00190$
00189$:
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:261: else fb_pattern=fb_pattern<<1;		// nächstes Datenbit
	mov	a,_fb_pattern
	add	a,_fb_pattern
	mov	_fb_pattern,a
00190$:
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:267: FBOUTC=1;						// Bus runterziehen
	setb	_P1_6
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:268: fbtx_bit=0;						// fbtx_bit dient zur späteren Kollisionsprüfung
	clr	_fbtx_bit
	sjmp	00195$
00194$:
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:270: else fbtx_bit=1;
	setb	_fbtx_bit
00195$:
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:271: telpos++;					// nächstes Byte
	inc	_telpos
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:272: fb_pattern=0;				// wieder mit Startbit beginnen
	mov	_fb_pattern,#0x00
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:273: fb_state=13;				// Prüfen ob Telegramm fertig
	mov	_fb_state,#0x0D
00198$:
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:275: TH1=18; //reload 70µ -delay interrupt (von state 11 auf 13)
	mov	_TH1,#0x12
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:281: repeat_count++;		// angefangener Sendeversuch, also Zähler erhöhen
	inc	_repeat_count
00203$:
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:289: fb_state=10;//12;
	mov	_fb_state,#0x0A
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:290: TH1=110;// 35µs + delay (von state 10 auf 11)
	mov	_TH1,#0x6E
00207$:
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:292: IE1=0;					// Flipflop löschen
	clr	_TCON_3
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:293: break;
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:299: case 13:	// Byte übertragen, T=35us, prüfen ob Telegramm fertig
	sjmp	00217$
00208$:
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:302: TMOD=(TMOD & 0x0F) +0x10;	// Timer 1 als 16-Bit Timer
	...
	add	a,#0x10
	mov	_TMOD,a
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:303: TH1=0xFB;					// Timer 1 auf Interbyte Abstand setzen (3 Bit Pause = 312µs 
	mov	_TH1,#0xFB
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:312: init_rx();	// Telegramm senden abgeschlossen, ggf. wiederholen wenn nicht geackt wird
	...
	sjmp	00214$
00210$:
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:314: else fb_state=14;		// nächstes Byte: Interbyte Abstand einhalten
	mov	_fb_state,#0x0E
00214$:
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:369: for(n=0;n<cs_pos;n++) {
	...
	sjmp	00101$
00104$:
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:372: telegramm[cs_pos]=cs;				// Checksum hinter Nutzdaten anfügen
	mov	a,r7
	add	a,#_telegramm
	mov	r0,a
	mov	@r0,_cs
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:375: wait_for_ack=1;
	setb	_wait_for_ack
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:377: fb_state=10;						// nächster state: senden
	mov	_fb_state,#0x0A
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:378: fb_pattern=0;						// nächstes zu sendendes Bit, 0=Startbit
	mov	_fb_pattern,#0x00
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:379: telpos=0;							// nächstes zu sendende Byte
	mov	_telpos,#0x00
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:497: build_ok=1;
	setb	b0
00131$:
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:499: if(repeatflag) telegramm[0]&=0xDF;		// Wiederholungsbit löschen für Wiederholtelegramm
	jnb	b1,00133$
	mov	a,#0xDF
	anl	a,_telegramm
	mov	_telegramm,a
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:552: if(apdu==READ_MEMORY_REQUEST) {		// 01pppp10 0000xxxx
	...
	ret
00220$:
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:553: mem_length=telegramm[7];		// Anzahl Bytes für späteres(!) memory Auslesen
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:645: FMDATA=telegramm[9];	// nächstes Byte, da autoinkrement
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:741: EA=1;			// Interrupts prinzipiell freigeben
	setb	_IEN0_7
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:743: IP0=0x04;		// höchste Priorität fuer ext1
	mov	_IP0,#0x04
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:747: status60=0x2E;	// Status-Byte (steht normal im userram an 0x60)
	mov	_status60,#0x2E
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:749: ack=0;			// ack und nack flag zurücksetzen
	clr	_ack
...
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:753: tel_arrived=0;	// kein Telegramm empfangen
	clr	_tel_arrived
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:754: auto_ack=1;		// empfangene Telegramme automatisch mit ack bestätigen
	setb	_auto_ack
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:755: tx_nextwrite=0;	// Zeiger auf nächste zu schreibende Objektnr. in tx_buffer
	mov	_tx_nextwrite,#0x00
;	C:/Freebus/C_Programme/oldisprogramm/lib_lpc922/fb_lpc922.c:756: tx_nextsend=0;	// Zeiger auf nächste zu sendende Objektnr. in tx_buffer
