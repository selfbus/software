...
//__bit strom0_fl=0;
unsigned char dimmcompare,cmd,dimmcompare_help=0,integral=0,phase;
signed char error_count=1;
...
/*
	...
	__asm
	mov a,r7			;dc_mess in den akku
		jz $00001			; wenn 0 dann nichts machen
		jb acc.7,$00002		; wenn kleiner 0 dann...
		jnb acc.1,$00003	; wenn >1 dann 2 zusätzlich erniedrigen
		dec _dimmcompare
		dec _dimmcompare
$00003:	dec _dimmcompare	;erniedrigen um auf 0 zu kommen
		sjmp $00001			;
$00002:	jb acc.1,$00004		;wenn < 0-1 dann 2 zusätzlich erhöhen
		inc _dimmcompare
		inc _dimmcompare
$00004:	inc _dimmcompare	;sonst erhöhen um auf 0 zu kommen
$00001:	__endasm;
*/	
